...
use App\Http\Resources\KpiSettingsTotalCollection;
use App\Http\Resources\KpiSettingsTotalResource;
use App\Repositories\SysKpiRepository;
use App\Services\KpiSettingsTotalService;
use Illuminate\Http\Request;


class KpiSettingsTotalController extends RestfulController{

    protected  $kpiSettings;


    public function __construct(KpiSettingsTotalService $kpiSettings)
    {
        parent::__construct();
    ...
    public function index()
    {
        try {
            ...
            return new KpiSettingsTotalCollection($rs);
        } catch (\Exception $e) {
    ...
    public function show($id){
        ...
        try{
            ...
            return  new KpiSettingsTotalResource($result['data']);
        }catch(\Exception $e){
            return $this->_error($e, self::HTTP_INTERNAL_ERROR);
        }
    }
