...
use App\Http\Resources\CostsFixedCollection;
use App\Http\Resources\CostsFixedResource;
...
class CostsFixedController extends RestfulController
{
    protected $costsService;

    public function __construct(CostsFixedService $costsService)
    {
        parent::__construct();
    ...
    public function index(Request $request)
    {
        try {
            ...
            return new CostsFixedCollection($rs);
        } catch (\Exception $e) {
    ...
    public function show($id){
        try{
           ...
           return new CostsFixedResource($result['data']);
